...
async function renderSocialAssets() {
  ...
  await sharp("assets/icons/ki-packt-an-logo.svg")
    .resize(512, 512)
    .png()
    .toFile("assets/social/ki-packt-an-logo-512.png");

  await sharp("assets/social/ki-packt-an-social.svg")
    .png()
    .toFile("assets/social/ki-packt-an-social.png");
}
...
function updateHomepageHead() {
  ...
  const homepageDirectory = `<section class="section directory-section" aria-labelledby="seiten-title">
        <div class="section-heading">
          ...
          <p>Hier finden Sie ergänzende Seiten zu typischen Einsatzfeldern, Kosten, Sicherheit und technischen Grenzen, falls Sie vor einer Anfrage einzelne Themen genauer einordnen möchten.</p>
        </div>
...
write(
  ...
  <path d="M86 352V160h47v75l69-75h58l-78 83 84 109h-58l-58-77-17 18v59H86Zm207 0V160h49v192h-49Z" transform="translate(62 66) scale(0.4296875)" fill="#ffffff"/>
  <path d="M362 352V160h64v192h-64Z" transform="translate(62 66) scale(0.4296875)" fill="#d8f36a"/>
  ...
  <g font-family="Arial, sans-serif" font-size="28" font-weight="700" fill="#18202f" dominant-baseline="middle">
    <rect x="328" y="456" width="138" height="54" rx="12" fill="#d8f36a"/>
    <text x="397" y="484" text-anchor="middle">E-Mail</text>
    <rect x="490" y="456" width="120" height="54" rx="12" fill="#ffffff"/>
    <text x="550" y="484" text-anchor="middle">CRM</text>
    <rect x="634" y="456" width="122" height="54" rx="12" fill="#ffffff"/>
    <text x="695" y="484" text-anchor="middle">ERP</text>
    <rect x="780" y="456" width="220" height="54" rx="12" fill="#ffffff"/>
    <text x="890" y="484" text-anchor="middle">Dokumente</text>
  </g>
</svg>
`,
);
