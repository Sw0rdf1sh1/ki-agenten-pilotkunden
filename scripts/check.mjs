...
const required = [
  ...
  "Gute Startprozesse erkennen",
  "Informationen wiederholt zusammengesucht",
  "Kein guter Start: einmalige Sonderfälle",
  "unklare Verantwortung, ungepflegte Stammdaten",
  ...
  "Ich begleite die Umsetzung persönlich",
  "Sie sprechen direkt mit Fabian",
